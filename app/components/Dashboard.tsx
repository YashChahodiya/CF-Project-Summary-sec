  ...
  return (
    <div className="space-y-4 p-4 overflow-y-auto sidebar">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
        <div className="bg-white border rounded-md  hover:shadow-lg transition-shadow duration-500 p-4">
          <Suspense fallback={<p>Loading Project Summary...</p>}>
            <ProjectSummary data={project_summary} />
          </Suspense>
        </div>
        <div className="bg-white border rounded-md  hover:shadow-lg transition-shadow duration-500 px-4 pt-4">
          <Suspense fallback={<p>Loading Summary Percentages...</p>}>
            <SummaryPercentages data={data.data} />
          </Suspense>
        </div>
        <div className="bg-white rounded-md  hover:shadow-lg transition-shadow duration-500 px-4 pt-4">
      ...
      <div className="bg-white border rounded-md  hover:shadow-lg transition-shadow duration-500 p-4 h-60">
        <Schedular />
      </div>
    </div>
  );
